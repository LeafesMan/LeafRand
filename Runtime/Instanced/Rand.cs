...
namespace LeafRand.Instanced
{
    ...
    {   // Just a BurstRand wrapped in a class
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public  T Item<T>(IReadOnlyList<T> items) => state.Item(items);
        /// <include file="../Docs.xml" path="Doc/Item/ListList"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public  T ItemWeighted<T>(IReadOnlyList<Weighted<T>> weightedItems) => state.ItemWeighted(weightedItems);
        /// <include file="../Docs.xml" path="Doc/Items/WithReplacement/ListInt"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public  T[] ItemsWithReplacement<T>(IReadOnlyList<T> items, int count) => state.ItemsWithReplacement(items, count);
        /// <include file="../Docs.xml" path="Doc/Items/WithoutReplacement/ListInt"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public  T[] ItemsWithoutReplacement<T>(IReadOnlyList<T> items, int count) => state.ItemsWithoutReplacement(items, count);
        /// <include file="../Docs.xml" path="Doc/Items/WithReplacement/ListListInt"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public  T[] ItemsWeightedWithReplacement<T>(IReadOnlyList<Weighted<T>> weightedItems, int count) => state.ItemsWeightedWithReplacement(weightedItems, count);
        /// <include file="../Docs.xml" path="Doc/Items/WithoutReplacement/ListListInt"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public  T[] ItemsWeightedWithoutReplacement<T>(IReadOnlyList<Weighted<T>> weightedItems, int count) => state.ItemsWeightedWithoutReplacement(weightedItems, count);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public  int Index<T>(IReadOnlyCollection<T> items) => state.Index(items);
