...
namespace LeafRand
{
    ...
    {   // Just a BurstRand wrapped in a static class
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T Item<T>(IReadOnlyList<T> items, IReadOnlyList<float> weights) => state.Item(items, weights);
        /// <include file="Docs.xml" path="Doc/Item/WeightedList"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T Item<T>(WeightedList<T> weightedList) => state.Item(weightedList.Items, weightedList.Weights);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T[] ItemsWithReplacement<T>(IReadOnlyList<T> items, IReadOnlyList<float> weights, int count) => state.ItemsWithReplacement(items, weights, count);
        /// <include file="Docs.xml" path="Doc/Items/WithoutReplacement/ListListInt"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T[] ItemsWithoutReplacement<T>(IReadOnlyList<T> items, IReadOnlyList<float> weights, int count) => state.ItemsWithReplacement(items, weights, count);
        /// <include file="Docs.xml" path="Doc/Items/WithReplacement/WeightedListInt"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T[] ItemsWithReplacement<T>(WeightedList<T> weightedList, int count) => state.ItemsWithReplacement(weightedList.Items, weightedList.Weights, count);
        /// <include file="Docs.xml" path="Doc/Items/WithoutReplacement/WeightedListInt"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T[] ItemsWithoutReplacement<T>(WeightedList<T> weightedList, int count) => state.ItemsWithoutReplacement(weightedList.Items, weightedList.Weights, count);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Shuffle<T>(IList<T> toShuffle) => state.Shuffle(toShuffle);
        #endregion
    }
}