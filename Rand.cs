 ...
 *  Date: 8/5/22  
 *  
 *  Desc: A System.Random wrapper providing extensive helper functions and a static instance.
 */
using UnityEngine;
...
public class Rand
{
    ...
    public Rand(int seed = 0) => rand = new System.Random(seed);

    [Tooltip("The Static Rand Instance.\n Seed is based on system clock at startup.")]
    public static Rand S { get; } = new(Environment.TickCount);
    #endregion
    #region Chance
    ///<summary>
